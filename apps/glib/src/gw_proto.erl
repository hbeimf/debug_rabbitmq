...
-export_type(['GetEntranceReq'/0, 'VerifyRes'/0, 'VerifyReq'/0, 'CommonStatus'/0, 'GetEntranceRes'/0, 'GetUpgradeReq'/0, 'TestSpeedRes'/0, 'GetUpgradeRes'/0, 'TestSpeedReq'/0, 'EnterGameRes'/0, 'EnterGameReq'/0]).

-spec encode_msg(#'GetEntranceReq'{} | #'VerifyRes'{} | #'VerifyReq'{} | #'CommonStatus'{} | #'GetEntranceRes'{} | #'GetUpgradeReq'{} | #'TestSpeedRes'{} | #'GetUpgradeRes'{} | #'TestSpeedReq'{} | #'EnterGameRes'{} | #'EnterGameReq'{}) -> binary().
encode_msg(Msg) -> encode_msg(Msg, []).


-spec encode_msg(#'GetEntranceReq'{} | #'VerifyRes'{} | #'VerifyReq'{} | #'CommonStatus'{} | #'GetEntranceRes'{} | #'GetUpgradeReq'{} | #'TestSpeedRes'{} | #'GetUpgradeRes'{} | #'TestSpeedReq'{} | #'EnterGameRes'{} | #'EnterGameReq'{}, list()) -> binary().
encode_msg(Msg, Opts) ->
    ...
    case Msg of
      ...
      #'TestSpeedReq'{} ->
	  e_msg_TestSpeedReq(Msg, TrUserData);
      #'EnterGameRes'{} ->
	  e_msg_EnterGameRes(Msg, TrUserData);
      #'EnterGameReq'{} -> e_msg_EnterGameReq(Msg, TrUserData)
    end.
...
get_msg_names() ->
    ['GetEntranceReq', 'VerifyRes', 'VerifyReq',
     'CommonStatus', 'GetEntranceRes', 'GetUpgradeReq',
     'TestSpeedRes', 'GetUpgradeRes', 'TestSpeedReq',
     'EnterGameRes', 'EnterGameReq'].
